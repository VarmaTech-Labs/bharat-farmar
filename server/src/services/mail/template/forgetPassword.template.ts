  ...
  <body>
    <div class="email-container">
      <div class="email-header">
        <h1>🔐 Bharat Farmer - पासवर्ड रीसेट कोड</h1>
      </div>
      <div class="email-body">
        <p>नमस्ते ${username} जी,</p>
        <p>आपका पासवर्ड रीसेट कोड नीचे दिया गया है:</p>
        <div class="otp-box">${otp}</div>
        <p>यह कोड केवल 10 मिनट तक मान्य है। कृपया इसे किसी के साथ साझा न करें।</p>
      </div>
